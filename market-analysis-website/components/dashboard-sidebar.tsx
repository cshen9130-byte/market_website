...
const navigation = [
  ...
  { name: "宏观市场", href: "/dashboard/macro-market", icon: TrendingUp },
  { name: "股票市场", href: "/dashboard/stock-market", icon: LineChart },
  { name: "期货市场", href: "/dashboard/futures-market", icon: Rocket },
  { name: "期权市场", href: "/dashboard/options-market", icon: Target },
  { name: "私募基金", href: "/dashboard/private-funds", icon: Briefcase },
]
